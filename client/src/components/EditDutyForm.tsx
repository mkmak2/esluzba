...
const EditDutyForm = ({people, editDuty,id, dutyList}: Props) => {
  ...
  return (
    <Box display='flex-col' width={500} sx={{borderRadius: 2, background: '#DFD7BF', padding: 2}}>
      ...
      <div className="form-line">
        <Button sx={{backgroundColor: '#AF8F6F', "&:hover": {backgroundColor: '#AF8F6F'}}}
         variant="contained" 
         onClick={() => onSubmit()}>Edytuj służbę</Button>
      </div>
      <div className="form-line">
        <span>{error}</span>
      </div>
